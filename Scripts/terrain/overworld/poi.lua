...
function initPoiTiles()
	...
	--RAFT Mod
	addPoiTileLegacy( POI_RAFT_CRASHEDSHIP_S, 1, "$CONTENT_DATA/Terrain/Tiles/AbandonedBoat(RaftMod).tile" )
	addPoiTileLegacy( POI_RAFT_WOCTEMPLE_XL, 1, "$CONTENT_DATA/Terrain/Tiles/WocTemple.tile" )
	addPoiTileLegacy( POI_RAFT_MAZE_S, 1, "$CONTENT_DATA/Terrain/Tiles/UnderwaterMazeRaftMod.tile" )
	addPoiTileLegacy( POI_RAFT_RUIN_M, 1, "$CONTENT_DATA/Terrain/Tiles/OnwaterRuinRaftMod.tile" )
	addPoiTileLegacy( POI_RAFT_RANGERSTATION_M, 1, "$CONTENT_DATA/Terrain/Tiles/RangerStation.tile" )
