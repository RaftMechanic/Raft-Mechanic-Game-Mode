...
function TorchTool:sv_createEffect()
	self.network:sendToClients("cl_effect")
end

function TorchTool:cl_effect()
	self.effect = sm.effect.createEffect("Fire - small01", self.tool:getOwner():getCharacter())
